...
This deployment pattern is the foundation that will allow VPN Tunnels to be created not only within an Azure Stack instance, between Azure Stack Instances and to other resources such as other onpremise networks.
